...
bp = Blueprint('jogos', __name__, url_prefix='/api/jogos')
CSV_PATH = 'data/jogos.csv'
FIELDNAMES = ['id', 'atleta_id', 'data', 'minutos', 'gols', 'assists']

@bp.route('/<int:atleta_id>', methods=['GET'])
def get_jogos_atleta(atleta_id):
...
def add_jogo():
    ...
    required = ['atleta_id', 'data', 'minutos', 'gols', 'assists']

...
bp = Blueprint('treinos', __name__, url_prefix='/api/treinos')
CSV_PATH = 'data/treinos.csv'
FIELDNAMES = ['id', 'atleta_id', 'data', 'carga', 'duracao_min']

@bp.route('/<int:atleta_id>', methods=['GET'])
def get_treinos_atleta(atleta_id):
...
def add_treino():
    ...
    required = ['atleta_id', 'data', 'carga', 'duracao_min']
